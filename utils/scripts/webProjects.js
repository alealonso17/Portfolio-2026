document.addEventListener("DOMContentLoaded", async () => {
  ...
  try {
    ...
    projects.forEach(project => {
      ...
      const securityHTML = project.securityFeatures
        .map(sec => `
      ...
      projectsContainer.innerHTML += `
        <div class="group bg-[#1a1a2e]/50 backdrop-blur-sm border border-indigo-500/20 rounded-2xl overflow-hidden hover:border-indigo-500/50 hover:shadow-2xl hover:shadow-indigo-500/20 transition-all">
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="p-6 lg:p-8">
              ...
              <div class="mb-6">
                ...
                <div class="px-3 py-2 bg-purple-500/10 border border-purple-500/30 rounded-lg text-sm text-purple-400">
              ...
              <div class="flex flex-wrap gap-3">
                <a href="${project.githubLink}" target="_blank"
                   class="px-5 py-2.5 bg-[#1a1a2e] border border-indigo-500/50 rounded-lg hover:border-indigo-400 transition-all flex items-center gap-2">
                  <i class="fas fa-code"></i>
                  <span>Source Code</span>
                </a>

                <a href="${project.securityDoc}" target="_blank"
                   class="px-5 py-2.5 bg-[#1a1a2e] border border-green-500/50 rounded-lg hover:border-green-400 transition-all flex items-center gap-2">
